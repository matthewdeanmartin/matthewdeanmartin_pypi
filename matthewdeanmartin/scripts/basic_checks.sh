...
run_cli() {
    "$CLI_PYTHON" -m matthewdeanmartin "$@"
}
...
echo "=== matthewdeanmartin basic_checks ==="
echo ""
echo "using: ${CLI_PYTHON} -m matthewdeanmartin"
echo ""

echo "--- global flags ---"
check "matthewdeanmartin --help"    run_cli --help
check "matthewdeanmartin --version" run_cli --version

# TODO: add subcommand smoke checks here, e.g.:
# check "matthewdeanmartin <subcommand> --help"  run_cli <subcommand> --help
